package com.cybermkd.plugin.c3p0;
 ...
 */
public class C3p0Plugin implements Plugin {
    ...
    private static Logger logger = Logger.getLogger(C3p0Plugin.class);

    public C3p0Plugin setDriverClass(String driverClass) {
        if (Stringer.isBlank(driverClass))
